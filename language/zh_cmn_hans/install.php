...
$lang = array_merge($lang, array(
	...
	'INTRODUCTION_BODY'		=> '欢迎来到phpBB3!<br /><br />phpBB® 是世界上使用最为广泛的开源论坛软件。phpBB3 是自2000年以来这一系列的最新产品。与之前的版本相比，phpBB3  具有更丰富的功能，更友好的操作界面，并拥有 phpBB 团队的完整技术支持。phpBB3 大幅提升了phpBB2 受人欢迎的功能，并且添加了众多用户迫切需要的新特性。我们希望 phpBB3 能超出您的期待.<br /><br />这个安装系统将全程引导您安装，从旧版升级或者转换不同的论坛(包括 phpBB2)到 phpBB3。要获取更多的信息，我们推荐您阅读<a href="../docs/INSTALL.html">安装指南</a>。<br /><br />要阅读 phpBB3 许可或了解如何获得支持及我们的立场，请在旁边的菜单中选择。继续下一步操作，请点击上方相应的标签。',

	// Support page
	'SUPPORT_TITLE'		=> '支持',
	'SUPPORT_BODY'		=> '我们将免费为此次发布的 phpBB3 稳定版本提供完全的技术支持。这包括:</p><ul><li>安装</li><li>设置</li><li>技术问题</li><li>与软件中潜在的 Bug 相关的问题</li><li>从先前发布的候选(RC)版本升级至最新稳定版本</li><li>从 phpBB 2.0.x 转换至 phpBB3</li><li>从其他的论坛转换至 phpBB3 (请访问 <a href="https://www.phpbb.com/community/viewforum.php?f=486">转换器论坛</a>)</li></ul><p>我们建议还在使用 phpBB3 Beta 版本的用户立即用最新的版本替换他们的系统.</p><h2>扩展/风格</h2><p>与扩展相关的问题，请发表在相应的 <a href="https://www.phpbb.com/community/viewforum.php?f=451">扩展论坛</a>.<br />与风格，模板和图集相关的问题，请发表在相应的 <a href="https://www.phpbb.com/community/viewforum.php?f=471">风格论坛</a>.<br /><br />如果您的问题与特定的包相关，请直接在相应包的主题后回帖.</p><h2>获得支持</h2><p><a href="https://www.phpbb.com/community/viewtopic.php?f=14&amp;t=571070">phpBB欢迎包</a><br /><a href="https://www.phpbb.com/support/">支持部分</a><br /><a href="https://www.phpbb.com/support/docs/en/3.1/ug/quickstart/">快速开始指南</a><br /><br />为了确保您获得最新版本的相关信息，为什么不<a href="https://www.phpbb.com/support/">订阅我们的邮件列表</a>？<br /><br />',
	...
	<ul>
		...
		<li>数据库用户名和密码 - 用于登录并访问上述数据库的登录资料。</li>
	</ul>
...
$lang = array_merge($lang, array(
	...
	'DB_HOST_EXPLAIN'		=> 'DSN 代表数据源名称，它只与 ODBC 安装有关。对于 PostgreSQL，需要通过 UNIX domain socket 用 localhost 或通过 TCP 用127.0.0.1连接本地服务器。对于 SQLite，需要输入数据库文件的完整路径。',
	'DB_PORT'				=> '数据库服务器端口',
	...
	//
	// Form labels
	'UPGRADE_INSTRUCTIONS'			=> '新特色 <strong>%1$s</strong> 可用。请阅读  <a href="%2$s" title="%2$s"><strong>the release announcement</strong></a> 来了解相关的信息，以及如何升级。',
	'SERVER_CONFIG'				=> '服务器配置',
	'SCRIPT_PATH'				=> '脚本路径',
...
$lang = array_merge($lang, array(
	...
	'DEFAULT_INSTALL_POST'			=> '这是新安装好的 phpBB3 论坛中的一个样本帖子。您可以删除这个帖子、这个主题甚至这个版面， 因为一切看起来都运转正常！在整个安装过程中，你的第一个分区和第一个版面，都已经给与了适当的权限，预定义的用户组，管理员，蜘蛛，以及总版主，游客，注册用户，注册的 COPPA 用户。',
	...
	'REPORT_WAREZ'					=> '此贴包含了非法或流氓软件的链接。',
	'REPORT_SPAM'					=> '此贴的唯一目的是为其它网站或软件做广告。',
...
$lang = array_merge($lang, array(
	...
	'UPDATE_INSTRUCTIONS'			=> '
		...
		<p>一旦上传普通用户将无法访问论坛，因为有 install 目录。<br /><br />
