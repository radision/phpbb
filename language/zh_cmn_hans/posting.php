...
$lang = array_merge($lang, array(
	...
	'LOGIN_EXPLAIN_BUMP'		=> '您需要登录后才能在这个版面顶话题。',
	...
	'MAX_FLASH_HEIGHT_EXCEEDED'	=> array(
		1	=> '您的flash文件可能只达到 %d 像素高。',
		2	=> '您的flash文件可能只达到 %d 像素高。',
	),
	'MAX_FLASH_WIDTH_EXCEEDED'	=> array(
		1	=> '您的flash文件可能只达到 %d 像素宽。',
		2	=> '您的flash文件可能只达到 %d 像素宽。',
	),
	'MAX_IMG_HEIGHT_EXCEEDED'	=> array(
		1	=> '您的图片文件可能只达到 %1$d 像素高。',
		2	=> '您的图片文件可能只达到 %1$d 像素高。',
	),
	...
	'MESSAGE_BODY_EXPLAIN'		=> array(
		...
		2	=> '输入您的信息在这里，可包含不多于<strong>%d</strong>个字符。',
	),
	...
	'PHP_UPLOAD_STOPPED'		=> '一个 PHP 扩展停止了文件上传。',
	...
	'POLL_OPTIONS_EXPLAIN'		=> array(
		1	=> '每行一个选项，您可以输入<strong>%d</strong>个选项。',
		2	=> '每行一个选项，您可以输入高达<strong>%d</strong>个选项。',
	),
	'POLL_OPTIONS_EDIT_EXPLAIN'		=> array(
		1	=> '每行一个选项，您可以输入<strong>%d</strong>个选项。如果您移除或添加选项，所有之前的投票将被重置。',
		2	=> '每行一个选项，您可以输入高达<strong>%d</strong>个选项。如果您移除或添加选项，所有之前的投票将被重置。',
	),
	'POLL_QUESTION'				=> '投票问题',
