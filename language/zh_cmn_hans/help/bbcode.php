...
$lang = array_merge($lang, array(
	...
	'HELP_BBCODE_LISTS_UNORDERER_ANSWER'	=> 'BBCode支持两种列表， 有序的和无序的。 他们本质上在HTML中是一样的。 一个无序的列表依次输出每个元素。 创建一个无序的列表您可以使用 <strong>[list][/list]</strong> 并在列表中使用 <strong>[*]</strong> 定义每个元素。 例如列出您最喜爱的颜色:<br /><br /><strong>[list]</strong><br /><strong>[*]</strong>Red<br /><strong>[*]</strong>Blue<br /><strong>[*]</strong>Yellow<br /><strong>[/list]</strong><br /><br />它会显示下面的样子:<ul><li>Red</li><li>Blue</li><li>Yellow</li></ul><br />另外您可以替换元素前的符号 <strong>[list=disc][/list]</strong>， <strong>[list=circle][/list]</strong>， 或者 <strong>[list=square][/list]</strong>。',
	'HELP_BBCODE_LISTS_UNORDERER_QUESTION'	=> '创建无序列表',

	'HELP_BBCODE_OTHERS_CUSTOM_ANSWER'	=> '当然可以--如果您是这个论坛的管理员并且拥有相应的权限，您可以通过自定义BBCode添加更多的BBCodes。',
	'HELP_BBCODE_OTHERS_CUSTOM_QUESTION'	=> '我能添加自己的标签吗？',

	'HELP_BBCODE_QUOTES_CODE_ANSWER'	=> '如果您需要输出一段固定宽度的代码或其他任何东西， 例如Courier字体， 您必须将文字包含在 <strong>[code][/code]</strong> 标签中， 例如<br /><br /><strong>[code]</strong>显示 "This is some code";<strong>[/code]</strong><br /><br />所有使用 <strong>[code][/code]</strong> 标签包围的文字格式将会以原来的形式显示。',
	'HELP_BBCODE_QUOTES_CODE_QUESTION'	=> '输出代码或修正宽度数据',
