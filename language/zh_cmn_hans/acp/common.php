...
$lang = array_merge($lang, array(
	...
	'ACP_MANAGE_ATTACHMENTS_EXPLAIN'	=> '这里您可以列出和删除贴子和私信中的附件。',
...
// PHP info
$lang = array_merge($lang, array(
	'ACP_PHP_INFO_EXPLAIN'	=> '这个页面列出了服务器上所安装的PHP的信息。这包括装载的模块，可用的变量和默认设定，在诊断问题时这些信息可能会有用。请注意一些主机服务商可能会因为安全因素禁止显示某些信息。您尽可能不要泄露这些信息，除非技术支持中的 <a href="https://www.phpbb.com/about/team/">官方开发成员</a> 需要这些信息。',
...
// Index page
$lang = array_merge($lang, array(
	'ADMIN_INTRO'				=> '感谢您选择 phpBB 作为论坛解决方案。这个界面将显示您的论坛的总体统计信息。左边的链接允许您从各个方面管理论坛，每个分页有如何使用管理工具的提示。',
	'ADMIN_LOG'					=> '记录的管理员操作',
	...
	'PHP_VERSION'		=> 'PHP 版本',
	'PHP_VERSION_OLD'	=> '当前服务器上的 PHP 版本 (%1$s) 将不被未来的 phpBB 版本所支持。 最低要求的版本是   PHP %2$s. %3$sDetails%4$s',
	...
	'VERSION_NOT_UP_TO_DATE_ACP'	=> '您安装的 phpBB 不是最新版的。<br /> 点击下面的链接可以查看新版的发行公告，以获取升级的信息。',
...
$lang = array_merge($lang, array(
	...
	'INACTIVE_USERS_EXPLAIN_INDEX'	=> '这个列表包括最近10个已注册但未激活的用户，账户未激活可能是因为在用户注册设置里已启用账户激活但这些用户还没被激活，也可能因为这些账户被禁用。点击下面的链接可得到一份完整的列表，您可以根据需要，来激活、删除或提醒（通过 email）这些用户。',
