...
$lang = array_merge($lang, array(
	...
	'COMMON_WORD_THRESHOLD_EXPLAIN'			=> '在所有的帖子中都频繁出现的单词将被识别为高频词。高频词在搜索中将被忽略。设置 0 则取消这项功能。只有当帖子数大于 100 时这个设置才能生效。调整过词频阈值后需要重新建立索引。',
	...
	'FULLTEXT_MYSQL_INCOMPATIBLE_DATABASE'	=> 'MySQL 全文检索后端只能在MySQL4或更高的版本中使用。',
	'FULLTEXT_MYSQL_NOT_SUPPORTED'				=> 'MySQL 全文索引只能用于 MyISAM 或 InnoDB 表。需要 MySQL 5.6.8 或更新版本来在 InnoDB 表中全文索引。',
	...
	'FULLTEXT_SPHINX_CONFIGURE'				=> '配置下面的设置生成 Sphinx 配置文件',
	...
	'FULLTEXT_SPHINX_HOST'					=> 'Sphinx 搜索进程主机',
	...
	'FULLTEXT_SPHINX_CONFIG_FILE_EXPLAIN'	=> '生成的内容是 Sphinx 配置文件，需要粘贴到 Sphinx.conf，用于 Sphinx 搜索进程。替换 [dbuser] 和 [dbpassword] 占位符用您的数据库帐号密码。',
	'FULLTEXT_SPHINX_NO_CONFIG_DATA'		=> 'Sphinx 数据和配置字典路径未定义，请定义它们来生成配置文件。',
  ...
  'MAX_NUM_SEARCH_KEYWORDS_EXPLAIN'      => '用于限制用户用于搜索的关键词的个数。填写 0 则不作限制。',
	...
	'SEARCH_INDEX_CREATE_REDIRECT'			=> array(
		2	=> '现有id %2$d 的贴子已被索引，正在索引 %1$d 帖子。<br />',
	),
