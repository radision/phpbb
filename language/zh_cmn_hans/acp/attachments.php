...
$lang = array_merge($lang, array(
	...
	'EXT_GROUP_FLASH_FILES'         => 'Flash 文件',
	'EXT_GROUP_IMAGES'            => '图片',
	'EXT_GROUP_PLAIN_TEXT'         => '纯文本文件',

	'FILES_GONE'			=> '一些您要删除的附件不存在，它们可能已被删除，曾经存在的附件已被删除。',
	'FILES_STATS_WRONG'		=> '您的文件统计数据好像不准确需要重新同步，实际值：附件数量 = %1$d，附件总大小 = %2$s。<br />点%3$s这里%4$s重新同步它们。',
	...
	'IMAGICK_PATH_EXPLAIN'		=> 'imagemagick 转换程序的完整路径， 例如 <samp>/usr/bin/</samp>',
	...
	'NO_FILE_CAT'				=> '无',
	'NO_IMAGE'					=> '没有图片',
	'NO_THUMBNAIL_SUPPORT'		=> '缩略图功能被禁用因为没有可支持的 GD 库函数和 imagemagick 可执行模块。',
