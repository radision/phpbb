...
$lang = array_merge($lang, array(
	'ACP_PRUNE_USERS_EXPLAIN'	=> '这里您可以将论坛中的会员删除（或者冻结）。 您可以有多种形式搜寻，然后删除。如：发帖数量和最后一次的时间等等... 这些方式可以自由组合， 如：您可以选用2001年1月1日之前发贴量少于10篇的会员来删除。 您也可以选择批量删除，只需要将会员名单放进删除栏目中即可。 此功能须小心使用！ 一旦用户被删除后将无法再恢复。',

	'CRITERIA'				=> '准则',

	'DEACTIVATE_DELETE'			=> '冻结或者删除',
	'DEACTIVATE_DELETE_EXPLAIN'	=> '选择冻结会员或者删除会员，注：删除会员操作无法恢复！',
	'DELETE_USERS'				=> '删除',
	'DELETE_USER_POSTS'			=> '被删除会员所发表的帖子同时被删除',
	'DELETE_USER_POSTS_EXPLAIN' => '删除被删除会员发表的帖子。若会员被冻结将不会被影响。',
