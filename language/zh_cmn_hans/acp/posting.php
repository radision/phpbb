...
$lang = array_merge($lang, array(
	...
	'BBCODE_DANGER'				=> '您添加的 BBCode 似乎在 HTML 属性中使用了 {TEXT} 标记。这可能会带来 XSS 安全隐患。请使用更安全的 {SIMPLETEXT} 或 {INTTEXT} 类型。除非您明白此设置的含义并确信使用 {TEXT} 并不会带来问题。',
	...
	'BBCODE_OPEN_ENDED_TAG'		=> '您的自定义 BBCode 必须包含开关标签。',
	'BBCODE_TAG'				=> '标签',
	...
	'tokens'	=>	array(
		'TEXT'			=> '任何文本，包括外文字符，数字等等..。您不能在 HTML 标签中使用这种类型，而必需使用 IDENTIFIER，INTTEXT 或 SIMPLETEXT。',
		'SIMPLETEXT'	=> '拉丁字符 (A-Z)，数字，空格，逗号，点，减号，加号，连字号和下划线',
		'INTTEXT'		=> 'Unicode字符，数字，空格，逗号，点，减号，加号，连字符和下划线。',
		'IDENTIFIER'	=> '拉丁字符 (A-Z)，数字，连字符和下划线',
		'NUMBER'		=> '任何数字序列',
		'EMAIL'			=> '有效的 email 地址',
		'URL'			=> '使用任何协议的有效的 URL(http，ftp，等等… 不能用作 javascript 刺探)。如果没有提供，将添加“http://”',
		'LOCAL_URL'		=> '本地 URL。 URL 必须和主题页相关并且不能包含服务器名称和协议，就像带前缀"%s"的链接',
		'RELATIVE_URL'	=> '相对 URL。您可以使用这个来匹配部分 URL，但是注意： 一个完整的 URL是一个有效的相对 URL。当您想使用相对 URL时,使用 LOCAL_URL 标记。',
