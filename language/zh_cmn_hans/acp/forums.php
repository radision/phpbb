...
$lang = array_merge($lang, array(
	...
	'FORUM_ADMIN'						=> '版面管理',
	'FORUM_ADMIN_EXPLAIN'				=> '在 phpBB3 中一切都是基于版面。 分区只是特殊的版面。每个版面可以拥有无限的子版面并且您可以决定哪些能发帖哪些不能（例如是否像一个旧分类）。这里您能添加、编辑、删除、锁定、解锁单独版面并适当设置一些额外控制。如果您的帖子和主题失去同步，您可以重新同步一下版面。<strong>要显示新创建的版面，您需要为它复制或设置适当的权限。</strong>',
