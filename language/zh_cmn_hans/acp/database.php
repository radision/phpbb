...
$lang = array_merge($lang, array(
	'ACP_BACKUP_EXPLAIN'	=> '这里您可以备份所有 phpBB 相关的数据。您可以将备份保存在 <samp>store/</samp> 文件夹或者直接下载。如果您的服务器支持，您可以将文件压缩成好几种格式。',
	'ACP_RESTORE_EXPLAIN'	=> '这将使用备份文件恢复所有的 phpBB 数据表。如果您的服务器支持，您可以使用 gzip 或 bzip2 这种文本文件压缩格式，会自动解压缩。<strong>警告</strong> 这将覆盖所有现在的数据。恢复可能需要一个很长的时间，在其完成前请不离开这个页面。备份存储在 <samp>store/</samp> 文件夹，由 phpBB 的备份功能生成。使用由其他系统生成的备份进行恢复操作可能会失败。',
