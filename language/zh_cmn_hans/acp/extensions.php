...
$lang = array_merge($lang, array(
	...
	'EXTENSIONS_EXPLAIN'		=> '扩展管理器是 phpBB 论坛的一个工具，允许您管理所有扩展状态和查看有关信息。',
	...
	'EXTENSION_NOT_INSTALLED'	=> '扩展 %s 不存在。请检查是否正确安装。 ',
	...
	'EXTENSION_DISABLE_CONFIRM'		=> '您确定要禁用 “%s” 扩展吗？',
	'EXTENSION_ENABLE_CONFIRM'		=> '您确定要启用 “%s” 扩展吗？',
	'EXTENSION_FORCE_UNSTABLE_CONFIRM'	=> '您确定要强制使用不稳定的版本吗？',
